...
import useTermsDetail from "../../hooks/useTermsDetail";
import ConfirmDialogModal from "@/shared/components/atoms/modal/ConfirmDialogModal";

const TermsDetail = () => {
  const { termsDetail, goBack, goToUpdate, handleDelete } = useTermsDetail();
